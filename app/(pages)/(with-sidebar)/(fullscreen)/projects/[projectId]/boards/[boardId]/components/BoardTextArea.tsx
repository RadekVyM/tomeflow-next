...
export default function BoardTextArea(props: {
    ...
    return (
        <textarea
            ref={textareaRef}
            className={cn("py-1 px-2.5 resize-none field-sizing-content min-h-0 bg-surface-container border border-outline-variant hover:border-outline outline-primary rounded-xl wrap-break-word thin-scrollbar", props.className)}
